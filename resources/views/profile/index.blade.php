...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                <div class="card-body">
                    <h4><i class="fa fa-pencil-alt" aria-hidden="true"></i>Edit Profile</h4>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" for="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" required>
                                    {{ $user->alamat}}
                                </textarea>
